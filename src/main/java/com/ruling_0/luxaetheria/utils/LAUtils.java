...
public class LAUtils {
    ...
    public static boolean checkRayCollision(World world, Vec3 startPos, Vec3 endPos, boolean includeWater) {
        ...
        return mop.typeOfHit != MovingObjectPosition.MovingObjectType.BLOCK
            || (mop.blockX == (startPos.xCoord - 0.5) || mop.blockY == (startPos.yCoord - 0.5)
                || mop.blockZ == (startPos.zCoord - 0.5))
            || (mop.blockX == (endPos.xCoord - 0.5) || mop.blockY == (endPos.yCoord - 0.5)
                || mop.blockZ == (endPos.zCoord - 0.5));
    }
}
